...
local comment = "#a37f8f"
local keyword = "#ff79c6"
local function_ = "#f1b4cc"
local string_ = "#b9f2ca"
local number = "#ffb7b2"
local type_ = "#e8c5e6"
local constant = "#ffd3b6"
local operator = "#f9a8d4"
local variable = "#fce4ec"
local param = "#ffaaa5"

local selection = "#5a3a48"
local cursor = "#ff79c6"
local line_num = "#5c4651"
local line_cur = "#ffb7b2"

local error = "#ff6b6b"
local warning = "#ffd166"
local info = "#4cc9f0"
local hinto = "#06d6a0"
