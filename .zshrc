...
local HEX_PINK="%F{#ff79c6}"
local HEX_ROSA="%F{#f1b4cc}"
local HEX_MATCHA="%F{#b9f2ca}"
local HEX_PEACH="%F{#ffb7b2}"
local HEX_ERROR="%F{#ff6b6b}"
local HEX_RESET="%F{reset}"
